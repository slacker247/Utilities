...
${OBJECTDIR}/_ext/2128269649/String.o: ../../../cpp/Utils/Utilities/String.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2128269649/String.o ../../../cpp/Utils/Utilities/String.cpp

${OBJECTDIR}/_ext/2128269649/Thread.o: ../../../cpp/Utils/Utilities/Thread.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2128269649
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2128269649/Thread.o ../../../cpp/Utils/Utilities/Thread.cpp

${OBJECTDIR}/_ext/2128269649/dllmain.o: ../../../cpp/Utils/Utilities/dllmain.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2128269649
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2128269649/dllmain.o ../../../cpp/Utils/Utilities/dllmain.cpp
